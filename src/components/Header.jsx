  ...
  return (
    <div className="text-dark">
      <div className="max-w-[800px] mt-[-90px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        ...
        <div className="flex justify-center items-center">
          ...
          <TypeAnimation
            ...
            sequence={["Ethereum", 2000, "Bitcoin", 2000, "Litecoin", 2000,"Ripple",2000]}
            wrapper="span"
            speed={20}
     ...
     "
        ...
        <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black" onClick={()=>navigate('/add_coin')}>
          Add Coin
        </button>
      </div>
    </div>
