...
import {
  ...
  const Footer = () => {
    return (
      <div className='max-w-[1240px] mx-auto py-16  grid lg:grid-cols-3 gap-8  font-bold text-black'>
        <div>
          <h1 className='w-full text-3xl font-bold text-[#000300]'>Daemonlite</h1>
